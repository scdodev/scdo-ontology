 ...
 * [scdo.yml](scdo.yml)
     * Determines how your purl.obolibrary.org/obo/scdo/ redirects will be handled
     ...
     * Paste in the contents of [scdo.yml](scdo.yml)
 ...
 * [scdo.md](scdo.md)
     ...
     * Paste in the contents of [scdo.md](scdo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
